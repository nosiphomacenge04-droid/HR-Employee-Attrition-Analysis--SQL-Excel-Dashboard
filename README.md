...
- Reviewed records containing missing data.
...
- Analysed average monthly income by job role.
- Examined employees with monthly income above specified thresholds.
- Analysed salary distribution.
- Analysed salary by job level and department.
- Investigated the impact of percentage salary increases on attrition.
- Analysed stock options in relation to employee retention.

### Employee Experience and Retention
- Analysed satisfaction scores in relation to attrition.
- Examined work-life balance distribution.
